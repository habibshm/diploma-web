	...
	<li><a href="fuserHome.php">Home</a></li>
		<div class="dropdown">
			...
			<div style="margin-left: 50%;">
				...
				<li>
				<input style="height: 40px; width: 55%; type="text" placeholder="Search game..." name="search" id="search" onblur="caps(this.id)">
...
$sgame = $_POST['search'];
$searchgame = strtoupper($sgame);


$sql = "SELECT * FROM games WHERE GAME_NAME LIKE '%$searchgame%' ORDER BY GAME_NAME ASC";
